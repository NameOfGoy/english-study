...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*bean.Tag) error
	CreateInBatches(values []*bean.Tag, batchSize int) error
	Save(values ...*bean.Tag) error
	First() (*bean.Tag, error)
	Take() (*bean.Tag, error)
	Last() (*bean.Tag, error)
	Find() ([]*bean.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*bean.Tag, err error)
	FindInBatches(result *[]*bean.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*bean.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*bean.Tag, error)
	FirstOrCreate() (*bean.Tag, error)
	FindByPage(offset int, limit int) (result []*bean.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*bean.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*bean.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*bean.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*bean.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*bean.Tag), nil
	}
}

func (t tagDo) Take() (*bean.Tag, error) {
...
func (t tagDo) Last() (*bean.Tag, error) {
...
func (t tagDo) Find() ([]*bean.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*bean.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*bean.Tag, err error) {
	buf := make([]*bean.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*bean.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*bean.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*bean.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*bean.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*bean.Tag) (result gen.ResultInfo, err error) {
