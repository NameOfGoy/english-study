...
func ArticleCandidatesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ArticleCandidatesReq
		...
		l := article.NewArticleCandidatesLogic(r.Context(), svcCtx, ui)
		resp, err := l.ArticleCandidates(&req)
