...
func GenerateArticleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GenerateArticleReq
		...
		l := article.NewGenerateArticleLogic(r.Context(), svcCtx, ui)
		resp, err := l.GenerateArticle(&req)
