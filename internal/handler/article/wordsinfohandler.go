...
func WordsInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WordsInfoReq
		...
		l := article.NewWordsInfoLogic(r.Context(), svcCtx, ui)
		resp, err := l.WordsInfo(&req)
