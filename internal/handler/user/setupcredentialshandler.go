...
func SetupCredentialsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetupCredentialsReq
		...
		l := user.NewSetupCredentialsLogic(r.Context(), svcCtx, ui)
		resp, err := l.SetupCredentials(&req)
