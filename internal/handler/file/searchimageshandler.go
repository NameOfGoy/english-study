...
func SearchImagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchImagesReq
		...
		l := file.NewSearchImagesLogic(r.Context(), svcCtx, ui)
		resp, err := l.SearchImages(&req)
