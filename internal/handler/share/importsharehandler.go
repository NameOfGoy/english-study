...
func ImportShareHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ImportShareReq
		...
		l := share.NewImportShareLogic(r.Context(), svcCtx, ui)
		resp, err := l.ImportShare(&req)
