...
func PreviewShareHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PreviewShareReq
		...
		l := share.NewPreviewShareLogic(r.Context(), svcCtx, ui)
		resp, err := l.PreviewShare(&req)
