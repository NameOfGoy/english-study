...
import (
	...
	"english-study/internal/logic/practise"
...
func GetStrengthWordCardListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordCardListReq
		...
		l := practise.NewGetStrengthWordCardListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetStrengthWordCardList(&req)
