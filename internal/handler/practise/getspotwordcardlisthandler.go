...
func GetSpotWordCardListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := practise.NewGetSpotWordCardListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetSpotWordCardList(&req)
