...
func FinishSpotHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FinishSpotReq
		...
		l := practise.NewFinishSpotLogic(r.Context(), svcCtx, ui)
		resp, err := l.FinishSpot(&req)
