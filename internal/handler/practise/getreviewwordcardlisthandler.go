...
func GetReviewWordCardListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := practise.NewGetReviewWordCardListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetReviewWordCardList(&req)
