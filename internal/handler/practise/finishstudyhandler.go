...
func FinishStudyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FinishStudyReq
		...
		l := practise.NewFinishStudyLogic(r.Context(), svcCtx, ui)
		resp, err := l.FinishStudy(&req)
