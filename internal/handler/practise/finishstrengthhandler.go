...
func FinishStrengthHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FinishStrengthReq
		...
		l := practise.NewFinishStrengthLogic(r.Context(), svcCtx, ui)
		resp, err := l.FinishStrength(&req)
