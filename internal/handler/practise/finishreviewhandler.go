...
func FinishReviewHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FinishReviewReq
		...
		l := practise.NewFinishReviewLogic(r.Context(), svcCtx, ui)
		resp, err := l.FinishReview(&req)
