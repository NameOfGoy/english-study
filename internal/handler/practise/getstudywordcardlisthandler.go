...
func GetStudyWordCardListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := practise.NewGetStudyWordCardListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetStudyWordCardList(&req)
