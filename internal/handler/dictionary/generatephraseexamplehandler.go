...
func GeneratePhraseExampleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GeneratePhraseExampleReq
		...
		l := dictionary.NewGeneratePhraseExampleLogic(r.Context(), svcCtx, ui)
		resp, err := l.GeneratePhraseExample(&req)
