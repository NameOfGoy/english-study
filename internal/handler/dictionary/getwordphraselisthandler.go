...
func GetWordPhraseListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordPhraseListReq
		...
		l := dictionary.NewGetWordPhraseListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetWordPhraseList(&req)
