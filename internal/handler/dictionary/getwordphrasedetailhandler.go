...
func GetWordPhraseDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordPhraseDetailReq
		...
		l := dictionary.NewGetWordPhraseDetailLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetWordPhraseDetail(&req)
