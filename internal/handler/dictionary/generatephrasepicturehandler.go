...
func GeneratePhrasePictureHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GeneratePhrasePictureReq
		...
		l := dictionary.NewGeneratePhrasePictureLogic(r.Context(), svcCtx, ui)
		resp, err := l.GeneratePhrasePicture(&req)
