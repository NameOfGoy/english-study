...
func UpdateWordTranslationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordTranslationReq
		...
		l := dictionary.NewUpdateWordTranslationLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWordTranslation(&req)
