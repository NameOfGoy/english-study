...
func DeletePhrasePictureHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeletePhrasePictureReq
		...
		l := dictionary.NewDeletePhrasePictureLogic(r.Context(), svcCtx, ui)
		resp, err := l.DeletePhrasePicture(&req)
