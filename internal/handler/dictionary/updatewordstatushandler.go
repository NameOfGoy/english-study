...
func UpdateWordStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordStatusReq
		...
		l := dictionary.NewUpdateWordStatusLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWordStatus(&req)
