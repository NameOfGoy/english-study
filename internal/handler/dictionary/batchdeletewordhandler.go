...
func BatchDeleteWordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchDeleteWordReq
		...
		l := dictionary.NewBatchDeleteWordLogic(r.Context(), svcCtx, ui)
		resp, err := l.BatchDeleteWord(&req)
