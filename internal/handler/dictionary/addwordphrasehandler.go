...
func AddWordPhraseHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddWordPhraseReq
		...
		l := dictionary.NewAddWordPhraseLogic(r.Context(), svcCtx, ui)
		resp, err := l.AddWordPhrase(&req)
