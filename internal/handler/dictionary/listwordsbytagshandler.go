...
func ListWordsByTagsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListWordsByTagsReq
		...
		l := dictionary.NewListWordsByTagsLogic(r.Context(), svcCtx, ui)
		resp, err := l.ListWordsByTags(&req)
