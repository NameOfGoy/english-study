...
func ExportWordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ExportWordReq
		...
		l := dictionary.NewExportWordLogic(r.Context(), svcCtx, ui)
		resp, err := l.ExportWord(&req)
