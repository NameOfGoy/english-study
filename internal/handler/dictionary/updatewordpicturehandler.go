...
func UpdateWordPictureHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordPictureReq
		...
		l := dictionary.NewUpdateWordPictureLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWordPicture(&req)
