...
func GetImportTaskListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetImportTaskListReq
		...
		l := dictionary.NewGetImportTaskListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetImportTaskList(&req)
