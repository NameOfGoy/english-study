...
func DeleteWordPictureHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteWordPictureReq
		...
		l := dictionary.NewDeleteWordPictureLogic(r.Context(), svcCtx, ui)
		resp, err := l.DeleteWordPicture(&req)
