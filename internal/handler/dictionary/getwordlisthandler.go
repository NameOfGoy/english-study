...
func GetWordListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordListReq
		...
		l := dictionary.NewGetWordListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetWordList(&req)
