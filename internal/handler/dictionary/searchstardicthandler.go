...
func SearchStardictHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchStardictReq
		...
		l := dictionary.NewSearchStardictLogic(r.Context(), svcCtx, ui)
		resp, err := l.SearchStardict(&req)
