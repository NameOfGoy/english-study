...
func ImportWordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ImportWordReq
		...
		l := dictionary.NewImportWordLogic(r.Context(), svcCtx, ui)
		resp, err := l.ImportWord(&req)
