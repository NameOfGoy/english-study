...
func UpdateWordPhraseHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordPhraseReq
		...
		l := dictionary.NewUpdateWordPhraseLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWordPhrase(&req)
