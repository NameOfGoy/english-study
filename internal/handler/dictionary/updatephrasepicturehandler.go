...
func UpdatePhrasePictureHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdatePhrasePictureReq
		...
		l := dictionary.NewUpdatePhrasePictureLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdatePhrasePicture(&req)
