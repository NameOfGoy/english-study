...
func UpdateExampleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateExampleReq
		...
		l := dictionary.NewUpdateExampleLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateExample(&req)
