...
func GetWordTagListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordTagListReq
		...
		l := dictionary.NewGetWordTagListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetWordTagList(&req)
