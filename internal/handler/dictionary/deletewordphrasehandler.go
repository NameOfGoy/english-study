...
func DeleteWordPhraseHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteWordPhraseReq
		...
		l := dictionary.NewDeleteWordPhraseLogic(r.Context(), svcCtx, ui)
		resp, err := l.DeleteWordPhrase(&req)
