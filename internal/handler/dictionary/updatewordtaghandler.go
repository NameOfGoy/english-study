...
func UpdateWordTagHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordTagReq
		...
		l := dictionary.NewUpdateWordTagLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWordTag(&req)
