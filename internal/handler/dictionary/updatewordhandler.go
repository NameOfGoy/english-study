...
func UpdateWordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWordReq
		...
		l := dictionary.NewUpdateWordLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdateWord(&req)
