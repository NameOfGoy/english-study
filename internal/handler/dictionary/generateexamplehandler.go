...
func GenerateExampleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GenerateExampleReq
		...
		l := dictionary.NewGenerateExampleLogic(r.Context(), svcCtx, ui)
		resp, err := l.GenerateExample(&req)
