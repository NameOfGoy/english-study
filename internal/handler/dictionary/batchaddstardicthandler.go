...
func BatchAddStardictHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchAddStardictReq
		...
		l := dictionary.NewBatchAddStardictLogic(r.Context(), svcCtx, ui)
		resp, err := l.BatchAddStardict(&req)
