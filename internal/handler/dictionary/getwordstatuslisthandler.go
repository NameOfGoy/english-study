...
func GetWordStatusListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWordStatusListReq
		...
		l := dictionary.NewGetWordStatusListLogic(r.Context(), svcCtx, ui)
		resp, err := l.GetWordStatusList(&req)
