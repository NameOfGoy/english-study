...
func BatchDeleteWordPhraseHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchDeleteWordPhraseReq
		...
		l := dictionary.NewBatchDeleteWordPhraseLogic(r.Context(), svcCtx, ui)
		resp, err := l.BatchDeleteWordPhrase(&req)
