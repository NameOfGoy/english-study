...
func UpdatePhraseExampleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdatePhraseExampleReq
		...
		l := dictionary.NewUpdatePhraseExampleLogic(r.Context(), svcCtx, ui)
		resp, err := l.UpdatePhraseExample(&req)
