...
func RelayRefreshHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RelayRefreshReq
		...
		l := cc.NewRelayRefreshLogic(r.Context(), svcCtx, ui)
		resp, err := l.RelayRefresh(&req)
